...
export const MyMUITailwind = forwardRef(function Player(props, ref) {
  const { className = "", ...other } = props;

  return (
    <div className={`m-auto max-h-[240px] max-w-[600px] ${className}`} {...other} ref={ref}>
      <div className="space-y-6 rounded-t-xl border-b border-slate-100 bg-white p-4 pb-6 dark:border-slate-500 dark:bg-slate-800 sm:space-y-8 sm:p-10 sm:pb-8 lg:space-y-6 lg:p-6 xl:space-y-8 xl:p-10 xl:pb-8">
        <div className="flex items-center space-x-4">
          ...
          <div className="min-w-0 flex-auto space-y-1 font-semibold">
            ...
            <h2 className="truncate text-sm leading-6 text-slate-500 dark:text-slate-400">Scaling CSS at Heroku with Utility Classes</h2>

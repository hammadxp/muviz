...
export default function RowsContainer() {
  return (
    <>
      ...
      <Row endpoint="https://api.themoviedb.org/3/tv/airing_today" id="shows/airing-today" title="Airing today (Shows)" rowType="tv" />
      <Row endpoint="https://api.themoviedb.org/3/tv/on_the_air" id="shows/on-the-air" title="On the air (Shows)" rowType="tv" />
      <Row endpoint="https://api.themoviedb.org/3/tv/popular" id="shows/popular" title="Popular (Shows)" rowType="tv" />
      <Row endpoint="https://api.themoviedb.org/3/tv/top_rated" id="shows/top-rated" title="Top rated (Shows)" rowType="tv" /> */}

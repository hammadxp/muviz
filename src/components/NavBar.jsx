...
export default function NavBar() {
  ...
  if (!mobile) {
    return (
      <NavMenu.Root>
        <NavMenu.List className="fixed left-0 top-0 z-20 flex h-[72px] w-full items-center bg-slate-900 bg-opacity-50 px-12 backdrop-blur backdrop-filter">
          <NavMenu.Item>
  ...
  if (mobile) {
    return (
      <>
        <div className="fixed left-0 top-0 z-20 flex h-[56px] w-full items-center bg-slate-900 bg-opacity-50 px-12 backdrop-blur backdrop-filter">
